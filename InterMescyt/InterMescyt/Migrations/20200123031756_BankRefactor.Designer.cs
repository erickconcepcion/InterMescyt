...
namespace InterMescyt.Migrations
{
    ...
    [Migration("20200123031756_BankRefactor")]
    partial class BankRefactor
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("InterMescyt.Data.Execution", b =>
                {
                    ...
                    b.Property<int?>("TransactionBankNumber");
            ...
            modelBuilder.Entity("InterMescyt.Data.HeaderBank", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasAnnotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn);
            ...
            modelBuilder.Entity("InterMescyt.Data.TransLineBank", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasAnnotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn);
                    ...
                    b.HasIndex("HeaderBankId");

                    b.ToTable("TransLineBanks");
                });
            ...
            modelBuilder.Entity("InterMescyt.Data.TransLineBank", b =>
                {
                    b.HasOne("InterMescyt.Data.HeaderBank", "HeaderBank")
                        .WithMany("TransLineBanks")
                        .HasForeignKey("HeaderBankId")
                        .OnDelete(DeleteBehavior.Cascade);
                });
